...
const AGENTS = [
  {
    ...
    workflows: ['strategy_review', 'knowledge_retrieval', 'knowledge_intake', 'transcript_intake', 'setup_profile', 'marketing_content', 'proposal', 'delivery', 'document', 'creative_image', 'calendar_planning', 'security_audit', 'dev_spec', 'multi_department'],
  ...
  },
  {
    ...
    status: 'active',
    access: ['inbox', 'company/strategy', 'company/company_handbook_SSOT', 'company/commercial', 'company/marketing'],
    workflows: ['knowledge_intake', 'transcript_intake'],
...
const WORKFLOWS = [
  ...
  {
    id: 'transcript_intake', name: 'Transcript Intake',
    desc: 'Transcripts from the drop zone → classified → Maßnahmenvorschlag → approved measures executed.',
    chain: ['danny', 'mara', 'nora', 'danny', 'approval'],
  },
  {
